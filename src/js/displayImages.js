...
function displayImagesSection() {
  console.log("uruchomiono displayImagesSection");
  ...
  const imagesTextBg = document.querySelector(
    ".display-images__text-background"
  );
  ...
  // Check if section is visible while scrolling
...
export default displayImagesSection;
